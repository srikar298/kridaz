...
<Heading
  ...
  children={"Kridaz API Documentation"}
></Heading>
...
<div style={{ marginBottom: "2rem" }}>
  ...
  <SchemaTabs className={"openapi-tabs__security-schemes"}>
    ...
    <TabItem label={"API Key: CookieAuth"} value={"CookieAuth"}>
      <div>
        <table>
          <tbody>
            <tr>
...
>
  ...
  <span>Kridaz Support: [support@kridaz.com](mailto:support@kridaz.com)</span>
  <span>URL: [https://kridaz.com](https://kridaz.com)</span>
</div>
