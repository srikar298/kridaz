...
_Note on Overs:_ In cricket math, `19.3` overs is `19.5` (since 3 balls = 0.5 overs). The scoring app inherently handles this conversion before pushing stats to the scheduler.
