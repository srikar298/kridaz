          ...
          {step === 1 && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="space-y-3">
                ...
                >
                  <h3
                    className={`text-sm font-black uppercase tracking-tight ${requestType === "RESCHEDULE" ? "text-[#CCFF00]" : "text-white"}`}
                  >
                    Request Reschedule
                  </h3>
                ...
                >
                  <h3
                    className={`text-sm font-black uppercase tracking-tight ${requestType === "WALLET_REFUND" ? "text-[#CCFF00]" : "text-white"}`}
                  >
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    <h3
                      className={`text-sm font-black uppercase tracking-tight ${requestType === "RESCHEDULE_OR_REFUND" ? "text-[#CCFF00]" : "text-white"}`}
                    >
                      Reschedule First
                    </h3>
                    <span className="bg-[#CCFF00] text-black text-[8px] font-black uppercase px-1.5 py-0.5 rounded">
                      Recommended
                    </span>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-5 gap-2">
                  {previews.map((src, idx) => (
                    <div
                      key={idx}
                      className="relative aspect-square rounded-[6px] overflow-hidden border border-[#2D2D2D] bg-[#000000]"
                    >
                      <img
                        src={src}
                        alt="Preview"
