...
const ProfessionalDashboard = lazy(
  () => import("@features/professional/pages/ProfessionalDashboard")
);
...
const ReviewsTab = lazy(
  () => import("@features/professional/pages/ReviewsTab")
);
const SupportTab = lazy(
  () => import("@features/professional/pages/SupportTab")
);
const TrustScoreHistory = lazy(
  () => import("@features/professional/pages/TrustScoreHistory")
);
...
const UserTurf = lazy(() =>
  import("@features/turf").then((m) => ({ default: m.Turf }))
);
const UserTurfDetails = lazy(() =>
  import("@features/turf").then((m) => ({ default: m.TurfDetails }))
);
const UserTurfBookingHistory = lazy(() =>
  import("@features/turf").then((m) => ({ default: m.TurfBookingHistory }))
);
const UserProfile = lazy(() =>
  import("@features/profile").then((m) => ({ default: m.Profile }))
);
const UserBlogs = lazy(() =>
  import("@features/blogs").then((m) => ({ default: m.Blogs }))
);
const UserBlogDetail = lazy(() =>
  import("@features/blogs").then((m) => ({ default: m.BlogDetail }))
);
const Community = lazy(() =>
  import("@features/networking").then((m) => ({ default: m.Community }))
);
const FindPlayers = lazy(() =>
  import("@features/networking").then((m) => ({ default: m.FindPlayers }))
);
const UserWallet = lazy(() =>
  import("@features/wallet").then((m) => ({ default: m.Wallet }))
);
const GlobalSearch = lazy(() => import("@user/pages/GlobalSearch"));
const BookingPass = lazy(() =>
  import("@features/turf").then((m) => ({ default: m.BookingPass }))
);
const BookingInvoice = lazy(() =>
  import("@features/turf").then((m) => ({ default: m.BookingInvoice }))
);
const HostGame = lazy(() =>
...
const JoinGameDetails = lazy(() =>
  import("@features/games").then((m) => ({ default: m.JoinGameDetails }))
);
const MyHostedGames = lazy(() =>
  import("@features/games").then((m) => ({ default: m.MyHostedGames }))
);
...
const ProfessionalDetails = lazy(() =>
  import("@features/networking").then((m) => ({
    default: m.ProfessionalDetails,
  }))
);
const Messages = lazy(() =>
  import("@features/chat").then((m) => ({ default: m.Messages }))
);
const MyTeams = lazy(() =>
  import("@features/teams").then((m) => ({ default: m.Teams }))
);
const CheckoutPage = lazy(() =>
  import("@features/turf").then((m) => ({ default: m.CheckoutPage }))
);
const ScoringApp = lazy(() =>
  import("@features/scoring").then((m) => ({ default: m.ScoringApp }))
);
const MatchAnalytics = lazy(() =>
  import("@features/scoring").then((m) => ({ default: m.MatchAnalytics }))
);
const MatchDetails = lazy(() =>
  import("@features/scoring").then((m) => ({ default: m.MatchDetails }))
);
const Leaderboard = lazy(() =>
  import("@features/leaderboard").then((m) => ({ default: m.Leaderboard }))
);
const LiveOverlay = lazy(() =>
  import("@features/scoring").then((m) => ({ default: m.LiveOverlay }))
);
...
const TeamProfile = lazy(() =>
  import("@features/teams").then((m) => ({ default: m.TeamProfile }))
);
const ReelsFeed = lazy(() =>
  import("@features/reels").then((m) => ({ default: m.ReelsFeed }))
);
const UploadReel = lazy(() =>
  import("@features/reels").then((m) => ({ default: m.UploadReel }))
);
const ReelAnalytics = lazy(() =>
  import("@features/reels").then((m) => ({ default: m.ReelAnalytics }))
);
...
const CreatePostPage = lazy(
  () => import("@features/networking/pages/CreatePostPage")
);
const CreateStoryPage = lazy(
  () => import("@features/networking/pages/CreateStoryPage")
);
const LandingPage = lazy(() => import("@user/pages/LandingPage"));
const TournamentWizard = lazy(
  () => import("@features/tournament/pages/TournamentWizard")
);
const TournamentDashboard = lazy(
  () => import("@features/tournament/pages/TournamentDashboard")
);
const TournamentPublicPage = lazy(
  () => import("@features/tournament/pages/TournamentPublicPage")
);
...
const UserVenueOwnerLanding = lazy(() =>
  import("@features/business").then((m) => ({ default: m.VenueOwnerLanding }))
);
const ProfessionalLanding = lazy(() =>
  import("@features/business").then((m) => ({ default: m.ProfessionalLanding }))
);
const BusinessRegistration = lazy(() =>
  import("@features/business").then((m) => ({
    default: m.BusinessRegistration,
  }))
);
const ClaimVenueInvite = lazy(() =>
  import("@features/business").then((m) => ({ default: m.ClaimVenueInvite }))
);
...
const DataDeletionInstructions = lazy(() =>
  import("@features/legal").then((m) => ({
    default: m.DataDeletionInstructions,
  }))
);
const ContactUs = lazy(() =>
  import("@features/legal").then((m) => ({ default: m.ContactUs }))
);
const FAQ = lazy(() =>
  import("@features/legal").then((m) => ({ default: m.FAQ }))
);
...
const StreamSetup = lazy(() =>
  import("@features/streamer").then((m) => ({ default: m.StreamSetup }))
);
...
const AddTurf = lazy(() =>
  import("@features/venue-owner").then((m) => ({ default: m.AddTurf }))
);
const EditTurf = lazy(() =>
  import("@features/venue-owner").then((m) => ({ default: m.EditTurf }))
);
const TurfManagement = lazy(() =>
  import("@features/venue-owner").then((m) => ({ default: m.TurfManagement }))
);
const TurfDetails = lazy(() =>
  import("@features/venue-owner").then((m) => ({ default: m.TurfDetails }))
);
const VenueOwnerDashboard = lazy(() =>
  import("@features/venue-owner").then((m) => ({
    default: m.VenueOwnerDashboard,
  }))
);
const PartnerReviews = lazy(() =>
  import("@features/venue-owner").then((m) => ({ default: m.PartnerReviews }))
);
const PartnerBookings = lazy(() =>
  import("@features/venue-owner").then((m) => ({ default: m.PartnerBookings }))
);
const CustomerDirectory = lazy(() =>
  import("@features/venue-owner").then((m) => ({
    default: m.CustomerDirectory,
  }))
);
const VenueIntelligence = lazy(() =>
  import("@features/venue-owner").then((m) => ({
    default: m.VenueIntelligence,
  }))
);
const VenueOwnerRevenue = lazy(() =>
  import("@features/venue-owner").then((m) => ({
    default: m.VenueOwnerRevenue,
  }))
);
const VenueOwnerPromotions = lazy(() =>
  import("@features/venue-owner").then((m) => ({
    default: m.VenueOwnerPromotions,
  }))
);
const VenueBanking = lazy(() =>
  import("@features/venue-owner").then((m) => ({ default: m.VenueBanking }))
);
const PartnerSupport = lazy(() =>
  import("@features/venue-owner").then((m) => ({ default: m.PartnerSupport }))
);
...
const ProfessionalAvailability = lazy(() =>
  import("@features/networking").then((m) => ({
    default: m.ProfessionalAvailability,
  }))
);
const ProfessionalBookings = lazy(() =>
  import("@features/networking").then((m) => ({
    default: m.ProfessionalBookings,
  }))
);
const ProfessionalReviews = lazy(() =>
  import("@features/networking").then((m) => ({
    default: m.ProfessionalReviews,
  }))
);
const ProfessionalProfile = lazy(() =>
  import("@features/networking").then((m) => ({
    default: m.ProfessionalProfile,
  }))
);
const PracticeScheduling = lazy(() =>
  import("@features/networking").then((m) => ({
    default: m.PracticeScheduling,
  }))
);
const ProfessionalCustomers = lazy(() =>
  import("@features/networking").then((m) => ({
    default: m.ProfessionalCustomers,
  }))
);
const DashboardProfile = lazy(() =>
  import("@features/partner-profile").then((m) => ({
...
const router = createBrowserRouter([
  ...
  // Î“Ã¶Ã‡Î“Ã¶Ã‡ USER PORTAL (Fall-through Priority) Î“Ã¶Ã‡Î“Ã¶Ã‡
  {
    ...
    children: [
      ...
      {
        path: "matches/:matchId/stream-setup",
        element: (
          <ProtectedRoute>
            <S>
              <StreamSetup />
      ...
      // Business Auth
      {
        ...
        element: (
          <S>
            <BusinessRegistration defaultRole="venu_owners" />
          </S>
        ),
      },
      {
  ...
  {
    path: "/business/official",
    element: <Navigate to="/business/professional" replace />,
  },
  {
    path: "/business/scorer",
    element: <Navigate to="/business/professional" replace />,
  },
  ...
  {
    path: "/streamer",
    element: <Navigate to="/professional/streamer" replace />,
  },
  {
    path: "/business/streamer",
    element: <Navigate to="/business/professional" replace />,
  },
  // Catch-all (Global)
  { path: "*", element: <NotFound /> },
