...
const GroupInfoModal = ({ isOpen, onClose, chat }) => {
  ...
  return (
    <>
      ...
      {/* Sliding Drawer */}
      <div
        className={`absolute top-0 right-0 h-full w-full sm:w-[380px] bg-card border-l border-white/10 z-50 flex flex-col transition-transform duration-300 ease-in-out shadow-2xl ${isOpen ? "translate-x-0" : "translate-x-full"}`}
      >
        {/* Header - WhatsApp Style */}
        <div className="bg-card border-b border-white/10 px-5 py-4 flex items-center gap-4 shrink-0 shadow-sm">
          <Button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar">
          ...
          <div className="bg-card py-8 px-6 flex flex-col items-center mb-2 shadow-sm">
            <div className="w-40 h-40 rounded-full border border-white/5 bg-primary/10 flex items-center justify-center mb-6 overflow-hidden">
              {chat.groupImage ? (
                <img
                  src={chat.groupImage}
              ...
              <div className="flex flex-col gap-2 w-full">
                ...
                <div className="flex justify-end gap-3 mt-2">
                  ...
                  <Button
                    ...
                    className="bg-primary text-black px-4 py-1.5 rounded-full text-sm font-bold shadow-sm"
                  >
                    Save
                  </Button>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  {isAdmin && (
                    <Button
                      ...
                      className="text-white/20 group-hover/edit:text-white/60 hover:!text-primary transition-colors"
                    >
                      <svg
                        className="w-5 h-5"
                        fill="none"
          ...
          {chat.isCommunity && childGroups?.length > 0 && (
            <div className="bg-card py-4 px-6 mb-2 shadow-sm space-y-4">
          ...
          {chat.parentCommunity && (
            <div className="bg-card py-4 px-6 mb-2 shadow-sm">
              <h4 className="text-[13px] font-medium text-white/50 mb-3">
                Parent Community
              </h4>
              <div className="flex items-center gap-3 bg-card p-3 rounded-[8px] border border-white/5">
            ...
            <div className="bg-card py-4 px-6 mb-2 shadow-sm space-y-4">
              ...
              <div className="relative">
                <Input
                  ...
                  className="w-full bg-card border-none rounded-lg pl-10 pr-4 py-2.5 text-white outline-none text-sm placeholder:text-white/30"
                />
                <svg
                  ...
                  .map((user) => (
                    ...
                    >
                      ...
                      <Button
                        ...
                        className="text-primary opacity-0 group-hover:opacity-100 p-1.5 rounded-full hover:bg-primary/10 transition-all"
                        title="Add"
                      >
                        <svg
                          className="w-5 h-5"
          ...
          {/* Participants List */}
          <div className="bg-card py-4 shadow-sm mb-2">
            ...
            <div className="flex flex-col">
              ...
              {chat.users?.map((u, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      {isThisAdmin && (
                        <span className="border border-primary/40 text-primary text-[10px] uppercase tracking-wide px-1.5 py-0.5 rounded-sm">
                      ...
                      {isAdmin && !isThisAdmin && !isMe && (
                        <div className="flex items-center gap-1 opacity-0 group-hover/member:opacity-100 transition-opacity">
                          <Button
                            ...
                            className="text-primary hover:bg-primary/10 p-1.5 rounded-full transition-all"
                            title="Make Admin"
                          >
                            <svg
                              className="w-4 h-4"
              ...
              {chat.pendingMembers?.length > 0 && (
                <>
                  ...
                  <h4 className="text-[13px] font-medium text-transparent bg-clip-text bg-gradient-to-r from-primary/80 to-primary/80 px-6 my-2">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex flex-col justify-center">
                            ...
                            <p className="text-transparent bg-clip-text bg-gradient-to-r from-primary/60 to-primary/60 text-[11px] leading-tight mt-0.5">
                              Invite sent
                            </p>
                          </div>
                        </div>
          ...
          {/* Action Footer */}
          <div className="bg-card py-2 shadow-sm mb-10">
            {chat.isCommunity && isCreator ? (
              <Button
                onClick={handleDeleteCommunity}
                className="w-full flex items-center gap-4 px-6 py-4 hover:bg-white/[0.03] text-destructive transition-colors"
              >
                <svg
                  className="w-6 h-6"
                  fill="none"
