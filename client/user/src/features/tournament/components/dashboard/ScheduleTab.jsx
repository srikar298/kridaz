...
const ScheduleTab = ({ tournament }) => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="bg-gradient-to-r from-secondary/10 to-primary/10 border border-primary/30 rounded-2xl p-6 relative overflow-hidden">
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <Button
            ...
            className="flex-shrink-0 bg-primary text-black font-black px-6 py-3 rounded-full text-xs uppercase tracking-widest hover:bg-white transition-colors shadow-[0_0_20px_rgba(191,243,103,0.3)] hover:shadow-[0_0_30px_rgba(191,243,103,0.5)]"
          >
            Generate Bracket
          </Button>
        </div>
        <div className="absolute right-0 top-0 w-64 h-64 bg-gradient-to-br from-primary/20 to-transparent blur-3xl rounded-full -mr-20 -mt-20 pointer-events-none" />
      </div>
      ...
      <div className="bg-card border border-white/5 rounded-2xl p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <Button
            ...
            className="px-4 py-2 bg-primary/10 text-primary border border-primary/20 rounded-full text-xs font-bold transition-colors hover:bg-primary hover:text-black"
          >
            ...
            matches.map((match, i) => (
              ...
              >
                <div className="flex justify-between items-center mb-4">
                  <span className="text-[10px] font-black uppercase tracking-widest text-secondary bg-secondary/10 px-2 py-1 rounded">
