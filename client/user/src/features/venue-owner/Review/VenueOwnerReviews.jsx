      ...
      <div className="px-1 lg:px-3 lg:pt-2 lg:pb-3 space-y-4 animate-fade-in pt-0 pb-4 h-full relative">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-1/3 space-y-4 md:space-y-6">
            <div className="bg-card border border-white/10 rounded-[16px] p-4 md:p-6 shadow-[var(--shadow-2)]">
          ...
          <div className="w-full lg:w-2/3 space-y-6">
            {currentTurf ? (
              <>
                ...
                {/* Review List */}
                <div className="bg-card border border-white/10 rounded-[16px] p-6 space-y-6 shadow-[var(--shadow-2)]">
                  ...
                  <div className="space-y-4">
                    {reviews.length > 0 ? (
                      reviews.map((review) => (
                        ...
                        >
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center gap-3 flex-wrap">
                                <h3
                                  ...
                                  className="text-[13px] font-bold text-white uppercase tracking-widest cursor-pointer hover:text-primary transition-colors"
                                >
                                  {review.userName}
                                </h3>
                          ...
                          <div className="flex justify-end border-t border-white/10 pt-3">
                            <Button className="text-[10px] font-bold text-white/70 uppercase tracking-widest hover:text-primary flex items-center gap-1.5 transition-colors">
                      ...
                      <div className="flex flex-col items-center justify-center py-16 text-center border border-dashed border-white/10 rounded-[16px] bg-background">
              ...
              <div className="h-full min-h-[250px] md:min-h-[400px] flex flex-col items-center justify-center border border-dashed border-white/10 rounded-[16px] bg-background shadow-[var(--shadow-2)] p-6 text-center">
