                            ...
                            toast(
                              (t) => (
                                <div className="flex flex-col gap-2">
                                  <span className="text-sm font-bold">Please fill out your location (City & State) in your profile first!</span>
                                  <Button 
                                    onClick={() => { 
                                      navigate('/profile'); 
                                      toast.dismiss(t.id); 
                ...
                <section className="space-y-4" ref={locationRef}>
                  ...
                  <LocationVenuePicker 
                    ...
                    onBookSlot={(venue) => {
                      ...
                      sessionStorage.setItem("hostGameData", JSON.stringify(updatedGameData));
