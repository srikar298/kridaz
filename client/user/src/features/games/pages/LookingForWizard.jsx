...
const LookingForWizard = () => {
  ...
  // Form State
  const storedData = JSON.parse(sessionStorage.getItem("hostGameData_lookingFor"));
  ...
  useEffect(() => {
    sessionStorage.setItem("hostGameData_lookingFor", JSON.stringify(gameData));
  }, [gameData]);
                ...
                <section className="space-y-4" ref={locationRef}>
                  ...
                  <LocationVenuePicker 
                    ...
                    onBookSlot={(venue) => {
                      ...
                      sessionStorage.setItem("hostGameData_lookingFor", JSON.stringify(updatedGameData));
            ...
            {gameData.gameMode === "QUICK" && (
              <div className="bg-card border border-white/10 rounded-[16px] p-3 sm:p-4 shadow-xl shadow-black/30 mb-3">
                ...
                <div className="flex gap-3 pt-4 mt-4">
                  <Button
                    onClick={() => {
                      sessionStorage.removeItem("hostGameData_lookingFor");
                      navigate("/host-game");
                    }}
