  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-0 sm:p-4">
      ...
      <motion.div
        ...
        className="relative z-20 w-full max-h-[100dvh] overflow-y-auto sm:max-h-[90vh] sm:max-w-[470px] bg-background sm:rounded-[12px] sm:border border-white/10 shadow-2xl flex flex-col"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header / Close Button */}
        <div className="sticky top-0 z-30 flex items-center justify-between p-3 border-b border-white/5 bg-background/90 backdrop-blur-md">
