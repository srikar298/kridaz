          ...
          >
            ...
            >
              <div className="p-2 bg-white/5 rounded-[10px] group-hover/btn:bg-[#BFF367]/10 transition-colors">
                <Trophy
                  size={14}
                  className={`${showSportDropdown ? "text-[#BFF367]" : "text-gray-500"}`}
                />
              </div>
              ...
              <ChevronDown
                size={12}
                className={`ml-auto text-gray-600 transition-transform duration-500 ${showSportDropdown ? "rotate-180 text-[#BFF367]" : ""}`}
              />
            </button>
          ...
          >
            ...
            >
              <div className="p-2 bg-white/5 rounded-[10px] group-hover/btn:bg-[#BFF367]/10 transition-colors">
                <MapPin
                  size={14}
                  className={`${selectedState ? "text-[#BFF367]" : "text-gray-500"}`}
                />
              </div>
              ...
              <ChevronDown
                size={12}
                className={`ml-auto text-gray-600 transition-transform duration-500 flex-shrink-0 ${showStateDropdown ? "rotate-180 text-[#BFF367]" : ""}`}
              />
            </button>
          ...
          >
            ...
            >
              <div className="p-2 bg-white/5 rounded-[10px] group-hover/btn:bg-[#BFF367]/10 transition-colors">
                <Building2
                  size={14}
                  className={`${selectedCity ? "text-[#BFF367]" : "text-gray-500"}`}
                />
              </div>
              <div className="flex flex-col text-left flex-1 min-w-0 font-inter">
                <span className="text-[8px] font-black text-gray-500 uppercase tracking-widest leading-none mb-1">
              ...
              <ChevronDown
                size={12}
                className={`ml-auto text-gray-600 transition-transform duration-500 flex-shrink-0 ${showCityDropdown ? "rotate-180 text-[#BFF367]" : ""}`}
              />
            </button>
