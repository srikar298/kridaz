...
import { setFilters, resetFilters } from "@redux/slices/turfSlice";
  ...
  return (
    <div className="min-h-screen bg-background font-sans text-foreground pb-20 overflow-x-hidden">
      <div className="max-w-screen-2xl mx-auto px-4 md:px-6 pt-0 relative z-10">
        ...
        <div className="block lg:hidden mb-6 mt-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              className="bg-card border border-[rgba(255,255,255,0.08)] rounded-[16px] p-[13px] flex items-center justify-center text-foreground hover:bg-card transition-colors shadow-md shrink-0"
            >
          ...
          <div className="py-20 text-center">
            ...
            <Button
              onClick={() => {
                ...
                if (userLocation) {
                  dispatch(
                    setFilters({ lat: userLocation.lat, lng: userLocation.lng })
                  );
                }
              }}
      ...
      >
        ...
        <div className="p-6 space-y-8">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="text-[14px] font-medium text-white capitalize">
                  {searchFilters.sport || "All Sports"}
                </span>
              </div>
          ...
          <Button
            ...
            className="w-full mt-6 py-4 bg-card border border-[rgba(255,255,255,0.08)] text-white font-black uppercase tracking-wider rounded-[16px] hover:bg-white/5 transition-colors"
          >
            Clear All
          </Button>
        </div>
      ...
      >
        ...
        <div className="p-4 space-y-1">
          {[
            ...
            const isSelected = sport === "All" ? !searchFilters.sport : searchFilters.sport === sport;
            return (
              <Button
                key={sport}
                onClick={() => {
                  dispatch(setFilters({ sport: sport === "All" ? "" : isSelected ? "" : sport }));
                  setIsMobileSportsOpen(false);
                }}
