                    ...
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        ...
                        <h3 className="text-lg font-bold truncate">
                          {selectedDispute.bookingDetails?.turfName}
                        </h3>
                      </div>
                    </div>
                    <div className="space-y-4">
                      <div className="flex items-center justify-between p-3 bg-white/5 rounded-[8px] border border-white/5">
                        ...
                        <span className="text-xs font-bold text-white truncate">
                          {selectedDispute.bookingDetails?.ownerName}
                        </span>
                      </div>
                      <div className="flex items-center justify-between p-3 bg-white/5 rounded-[8px] border border-white/5">
                        <span className="text-xs text-gray-500 font-bold uppercase flex items-center gap-2">
                        ...
                        <span className="text-xs font-bold text-white">
                          {selectedDispute.bookingDetails?.ownerPhone || "N/A"}
                        </span>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="space-y-4">
                        <div className="flex justify-between items-center text-sm">
                          ...
                          <span className="font-bold">
                            ₹{selectedDispute.bookingDetails?.totalAmount}
                          </span>
                        </div>
                        <div className="flex justify-between items-center text-sm">
                          <span className="text-gray-400 font-bold uppercase text-[10px]">
                          ...
                          <span className="font-bold text-orange-400">
                            ₹{selectedDispute.bookingDetails?.ownerRevenue}
                          </span>
                        </div>
                        ...
                        <div className="flex justify-between items-center text-sm">
                          ...
                          <span className="font-bold text-[11px]">
                            {selectedDispute.bookingDetails?.slotLabel}
                          </span>
                        </div>
                        ...
                        {selectedDispute.slaDeadline &&
                          ...
                          selectedDispute.status !== "RESOLVED" && (
                            <div className="flex justify-between items-center text-sm">
                              ...
                              <span
                                className={`font-bold text-[11px] ${new Date(selectedDispute.slaDeadline) < new Date() ? "text-red-500" : "text-orange-400"}`}
                              >
                                {new Date(
                                  selectedDispute.slaDeadline
                                ).toLocaleString()}
