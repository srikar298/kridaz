...
const addVenueInviteSchema = z
  .object({
    ...
    description: z.string().min(1, "Enter the description of the turf"),
    location: z.string().min(1, "Enter the location of the turf"),
...
export default function useAddVenueInvite() {
  ...
  const submitToServer = async (data) => {
    ...
    try {
      ...
      data.closeTime = format(
        new Date(`${today}T${data.closeTime}`),
        "hh:mm aa"
      );
