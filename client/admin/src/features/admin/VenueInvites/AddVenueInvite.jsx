      ...
      <div className="h-full custom-scrollbar bg-background text-white p-6 md:p-12 animate-fade-in flex flex-col items-center justify-center">
        <div className="bg-card border border-primary/40 p-8 rounded-[24px] shadow-[0_8px_32px_rgba(179,220,38,0.15)] text-center max-w-lg w-full">
          ...
          <p className="text-white/70 text-sm mb-8">
            The magic link has been generated. Send this link to the venue
            owner.
          </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 relative z-10 animate-fade-in">
              <div className="form-control col-span-1 md:col-span-2">
                <label className="label mb-2">
                  <span className="text-xs font-bold text-white/70 uppercase tracking-widest ml-1">
              ...
              <div className="space-y-8">
                ...
                <div className="form-control">
                  ...
                  <p className="text-white/40 text-xs mt-3 ml-1">
                    Provide either email or phone to send the magic link.
                  </p>
                </div>
                    ...
                    {generatedSlots.map((slot, index) => (
                      ...
                      >
                        <div className="flex justify-between items-center mb-4 relative z-10">
                          <span
                            className={`text-xs font-bold font-mono tracking-tight ${slot.isActive ? "text-white" : "text-white/70"}`}
                          >
                            {slot.startTime}{" "}
