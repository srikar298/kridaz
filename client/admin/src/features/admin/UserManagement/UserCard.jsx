      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center relative z-10">
        ...
        <div className="lg:col-span-1 flex items-center justify-center">
          <Input
            ...
            className="w-5 h-5 rounded border-border bg-background text-primary focus:ring-primary/50 cursor-pointer"
          />
        </div>
        ...
        <div className="lg:col-span-3 flex items-center gap-5">
          <div className="relative shrink-0">
            ...
            <div className="relative border border-white/10 rounded-[8px] p-0.5 group-hover:border-primary/30 transition-colors bg-background">
              <Avatar
                name={user.name}
                size={42}
                round={true}
          ...
          <div className="min-w-0">
            <h3 className="text-[15px] font-black text-white uppercase tracking-tight group-hover:text-primary transition-colors truncate font-open-sans">
              {user.name}
            </h3>
        ...
        <div className="lg:col-span-2 flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-white/20 group-hover:text-primary transition-colors border border-white/5 group-hover:border-primary/20">
            <Mail size={14} />
          </div>
